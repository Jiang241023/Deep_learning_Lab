    ...
    data_paths = [
        {
            ...
            "output_folder": "dl-lab-24w-team04/DL_LAB_Diabetic_Retinopathy_Detection/revized_images/train",
        },
        {
            "sample_data_path": "/home/data/IDRID_dataset/images/test",
            "output_folder": "dl-lab-24w-team04/DL_LAB_Diabetic_Retinopathy_Detection/revized_images/test",
        }
    ]
