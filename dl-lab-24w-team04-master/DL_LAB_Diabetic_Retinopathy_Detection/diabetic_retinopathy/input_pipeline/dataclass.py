...
resized_folder = 'dl-lab-24w-team04/DL_LAB_Diabetic_Retinopathy_Detection/revized_images/test'
final_folder = 'dl-lab-24w-team04/DL_LAB_Diabetic_Retinopathy_Detection/revized_images/test/binary'
csv_file_path = 'DL_LAB_Diabetic_Retinopathy_Detection/labels/test.csv'
